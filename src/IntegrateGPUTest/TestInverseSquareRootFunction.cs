...
{
    [TestClass]
    public sealed class TestInverseSquareRootFunction
    {
        [TestMethod]
        public void TestInverseSquareRootX()
        {
            // f(x) = 1/sqrt(x), integral from 1 to 4 is 2
            ...
            Assert.AreEqual(expectedIntegral, estimatedIntegral, tolerance, "Integral of f(x)=1/sqrt(x) did not match expected value.");
        }
    }
}